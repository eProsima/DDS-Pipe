...
/*!
 * @file float_bounded_sequenceTypeObjectSupport.hpp
...
#ifndef _FAST_DDS_GENERATED_FLOAT_BOUNDED_SEQUENCE_TYPE_OBJECT_SUPPORT_HPP_
#define _FAST_DDS_GENERATED_FLOAT_BOUNDED_SEQUENCE_TYPE_OBJECT_SUPPORT_HPP_
...
/**
 * @brief Register float_bounded_sequence related TypeIdentifier.
 *        Fully-descriptive TypeIdentifiers are directly registered.
 *        Hash TypeIdentifiers require to fill the TypeObject information and hash it, consequently, the TypeObject is
 *        indirectly registered as well.
 */
eProsima_user_DllExport void register_float_bounded_sequence_type_identifier();
