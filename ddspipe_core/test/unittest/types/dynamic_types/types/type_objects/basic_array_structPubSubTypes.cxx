...
TheOtherObjectInArrayPubSubType::TheOtherObjectInArrayPubSubType()
{
    ...
    uint32_t type_size =
        ...
        static_cast<uint32_t>(TheOtherObjectInArray::getMaxCdrSerializedSize());
#else
    ...
    uint32_t keyLength = TheOtherObjectInArray_max_key_cdr_typesize > 16 ? TheOtherObjectInArray_max_key_cdr_typesize : 16;
...
basic_array_structPubSubType::basic_array_structPubSubType()
{
    ...
    uint32_t type_size =
#if FASTCDR_VERSION_MAJOR == 1
        static_cast<uint32_t>(basic_array_struct::getMaxCdrSerializedSize());
#else
        basic_array_struct_max_cdr_typesize;
#endif
    type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    m_typeSize = type_size + 4; /*encapsulation*/
    m_isGetKeyDefined = false;
    uint32_t keyLength = basic_array_struct_max_key_cdr_typesize > 16 ? basic_array_struct_max_key_cdr_typesize : 16;
    m_keyBuffer = reinterpret_cast<unsigned char*>(malloc(keyLength));
    memset(m_keyBuffer, 0, keyLength);
}
