...
/*!
 * @file basic_structTypeObjectSupport.hpp
...
#ifndef _FAST_DDS_GENERATED_BASIC_STRUCT_TYPE_OBJECT_SUPPORT_HPP_
#define _FAST_DDS_GENERATED_BASIC_STRUCT_TYPE_OBJECT_SUPPORT_HPP_
...
/**
 * @brief Register TheOtherObject related TypeIdentifier.
...
/**
 * @brief Register basic_struct related TypeIdentifier.
 *        Fully-descriptive TypeIdentifiers are directly registered.
 *        Hash TypeIdentifiers require to fill the TypeObject information and hash it, consequently, the TypeObject is
 *        indirectly registered as well.
 */
eProsima_user_DllExport void register_basic_struct_type_identifier();
