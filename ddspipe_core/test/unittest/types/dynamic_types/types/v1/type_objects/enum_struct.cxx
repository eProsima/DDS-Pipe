...
#define enum_struct_max_cdr_typesize 8ULL;

#define enum_struct_max_key_cdr_typesize 0ULL;
        ...
        const enum_struct& x) const
{
    ...
    return (m_index == x.m_index && m_enum_value == x.m_enum_value);
}
...
size_t enum_struct::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
    static_cast<void>(current_alignment);
    return enum_struct_max_key_cdr_typesize;
}
