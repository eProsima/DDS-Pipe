...
#define union_struct_max_cdr_typesize 268ULL;

#define union_struct_max_key_cdr_typesize 0ULL;
        ...
        const union_struct& x) const
{
    ...
    return (m_index == x.m_index && m_union_value == x.m_union_value);
}
...
size_t union_struct::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
    static_cast<void>(current_alignment);
    return union_struct_max_key_cdr_typesize;
}
