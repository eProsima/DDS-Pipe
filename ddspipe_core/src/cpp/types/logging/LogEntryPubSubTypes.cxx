...
{
    set_name("LogEntry");
    uint32_t type_size = LogEntry_max_cdr_typesize;
    type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    max_serialized_type_size = type_size + 4; /*encapsulation*/
    is_compute_key_provided = true;
    uint32_t key_length = LogEntry_max_key_cdr_typesize > 16 ? LogEntry_max_key_cdr_typesize : 16;
...
bool LogEntryPubSubType::deserialize(
        SerializedPayload_t& payload,
        void* data)
{
    try
...
uint32_t LogEntryPubSubType::calculate_serialized_size(
        const void* const data,
        DataRepresentationId_t data_representation)
{
    try
...
void* LogEntryPubSubType::create_data()
{
    return reinterpret_cast<void*>(new LogEntry());
}

void LogEntryPubSubType::delete_data(
        void* data)
{
    delete(reinterpret_cast<LogEntry*>(data));
}

bool LogEntryPubSubType::compute_key(
        SerializedPayload_t& payload,
        ...
        bool force_md5)
{
    ...
    if (force_md5 || LogEntry_max_key_cdr_typesize > 16)
    {
        md5_.init();
...
#include <ddspipe_core/types/logging/LogEntryCdrAux.ipp>
