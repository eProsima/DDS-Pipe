...
#include <ddspipe_core/types/logging/v2/LogEntryCdrAux.hpp>
    ...
    return [data, data_representation]() -> uint32_t
           {
               ...
               return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<LogEntry*>(data))) +
                      4u /*encapsulation*/;
#else
               try
               {
...
void* LogEntryPubSubType::createData()
{
    return reinterpret_cast<void*>(new LogEntry());
}

void LogEntryPubSubType::deleteData(
        void* data)
{
