...
public:
    ...
    // /**
    //  * @brief Reserve a new \c payload of max size \c size .
    //  *
    //  * This method calls \c get_payload for the serialized payload.
    //  * The \c payload owner is set to \c this .
    //  *
    ...
    //  * It sets values to the serialized \c payload .
    //  *
    //  * This method calls \c get_payload for the serialized payload.
    //  * The \c payload owner is set to \c this .
    //  *
    ...
    //  * The \c payload owner is set to \c nullptr .
    //  *
    //  * @param [in,out] payload  to release
    //  *
    //  * @return true if everything ok
    //  * @return false if something went wrong
    //  *
