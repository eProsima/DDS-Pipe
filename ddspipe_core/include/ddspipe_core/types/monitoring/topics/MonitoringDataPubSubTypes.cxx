...
/*!
 * @file MonitoringDataPubSubTypes.cpp
...
#include "MonitoringDataPubSubTypes.h"
#include "MonitoringDataCdrAux.hpp"
...
MonitoringDataPubSubType::MonitoringDataPubSubType()
{
    setName("MonitoringData");
    uint32_t type_size =
#if FASTCDR_VERSION_MAJOR == 1
        static_cast<uint32_t>(MonitoringData::getMaxCdrSerializedSize());
#else
        MonitoringData_max_cdr_typesize;
#endif
    type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    m_typeSize = type_size + 4; /*encapsulation*/
    m_isGetKeyDefined = false;
    uint32_t keyLength = MonitoringData_max_key_cdr_typesize > 16 ? MonitoringData_max_key_cdr_typesize : 16;
    m_keyBuffer = reinterpret_cast<unsigned char*>(malloc(keyLength));
    memset(m_keyBuffer, 0, keyLength);
}
...
bool MonitoringDataPubSubType::serialize(
        void* data,
        SerializedPayload_t* payload,
        DataRepresentationId_t data_representation)
{
    MonitoringData* p_type = static_cast<MonitoringData*>(data);
...
bool MonitoringDataPubSubType::deserialize(
        SerializedPayload_t* payload,
        void* data)
{
    try
...
std::function<uint32_t()> MonitoringDataPubSubType::getSerializedSizeProvider(
        void* data,
        DataRepresentationId_t data_representation)
{
    return [data, data_representation]() -> uint32_t
...
#if FASTCDR_VERSION_MAJOR == 1
               static_cast<void>(data_representation);
               return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<MonitoringData*>(data))) +
                      4u /*encapsulation*/;
#else
               try
               {
                   ...
                   size_t current_alignment {0};
                   return static_cast<uint32_t>(calculator.calculate_serialized_size(
                               *static_cast<MonitoringData*>(data), current_alignment)) +
                           4u /*encapsulation*/;
               }
               catch (eprosima::fastcdr::exception::Exception& /*exception*/)
               {
...
void* MonitoringDataPubSubType::createData()
{
    return reinterpret_cast<void*>(new MonitoringData());
}

void MonitoringDataPubSubType::deleteData(
        void* data)
{
    delete(reinterpret_cast<MonitoringData*>(data));
}

bool MonitoringDataPubSubType::getKey(
        void* data,
        InstanceHandle_t* handle,
        bool force_md5)
{
    ...
    // Object that manages the raw buffer.
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
            MonitoringData_max_key_cdr_typesize);
    ...
    eprosima::fastcdr::serialize_key(ser, *p_type);
#endif // FASTCDR_VERSION_MAJOR == 1
    if (force_md5 || MonitoringData_max_key_cdr_typesize > 16)
    {
        m_md5.init();
#if FASTCDR_VERSION_MAJOR == 1
        m_md5.update(m_keyBuffer, static_cast<unsigned int>(ser.getSerializedDataLength()));
