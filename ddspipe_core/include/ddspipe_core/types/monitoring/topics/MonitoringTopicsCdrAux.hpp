...
#ifndef FAST_DDS_GENERATED__MONITORINGTOPICSCDRAUX_HPP
#define FAST_DDS_GENERATED__MONITORINGTOPICSCDRAUX_HPP
...
constexpr uint32_t MonitoringTopics_max_cdr_typesize {12UL};
constexpr uint32_t MonitoringTopics_max_key_cdr_typesize {0UL};

constexpr uint32_t DdsTopic_max_cdr_typesize {536UL};
...
#endif // FAST_DDS_GENERATED__MONITORINGTOPICSCDRAUX_HPP
