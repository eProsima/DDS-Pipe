...
#define MonitoringData_max_cdr_typesize 2852816ULL;
...
MonitoringData& MonitoringData::operator =(
        const MonitoringData& x)
{
    m_topics = x.m_topics;
...
size_t MonitoringData::getMaxCdrSerializedSize(
        size_t current_alignment)
{
    static_cast<void>(current_alignment);
    return MonitoringData_max_cdr_typesize;
}

size_t MonitoringData::getCdrSerializedSize(
...
void MonitoringData::deserialize(
        eprosima::fastcdr::Cdr& dcdr)
{
    dcdr >> m_topics;
...
bool MonitoringData::isKeyDefined()
{
    return false;
}

void MonitoringData::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
}
 ...
 */
const std::vector<DdsTopic>& MonitoringData::topics() const
{
    return m_topics;
}
 ...
 */
std::vector<DdsTopic>& MonitoringData::topics()
{
    return m_topics;
}
