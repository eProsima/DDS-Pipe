...
/**
 * Test read Easy Mode IP from yaml
 */
TEST(YamlGetEntityAddressTest, get_easy_mode_ip)
{
    // string values
    {
        ...
        for (participants::types::IpType ip : ips)
        {
            ...
            ASSERT_EQ(ip, YamlReader::get<participants::types::IpType>(yml, EASY_MODE_TAG, LATEST));
        }
    }
}
